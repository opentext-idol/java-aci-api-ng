...
public class AciServiceExceptionTest {
    ...
    public void testDefaultConstructor() {
        // Create an empty one...
        final AciServiceException exception = new AciServiceException();
    ...
    public void testMessageConstructor() {
        ...
        final AciServiceException exception = new AciServiceException(message);
    ...
    public void testCauseConstructor() {
        ...
        // Create an exception with the message...
        final AciServiceException exception = new AciServiceException(cause);
    ...
    public void testMessageAndCauseConstructor() {
        ...
        // Create an exception with the message...
        final AciServiceException exception = new AciServiceException(message, cause);

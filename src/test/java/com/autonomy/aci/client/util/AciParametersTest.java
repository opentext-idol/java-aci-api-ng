 ...
 */
public class AciParametersTest {

    @Test
    @SuppressWarnings("unchecked")
    public void testDefaultConstructor() {
        // Check it's empty...
        assertThat("Non-empty parameter set", new AciParameters().isEmpty(), is(true));
    }
    ...
    public void testAciParameterConstructor() {
        ...
        final AciParameters parameters = new AciParameters(parameter);
    ...
    public void testActionConstructor() {
        // Create a new instance...
        final AciParameters parameters = new AciParameters("test");

        // Check it...
        assertThat("Wrong size for parameter set", parameters.size(), is(1));

        final AciParameter parameter = parameters.iterator().next();
    ...
    public void testCollectionConstructorNoDupes() {
        // Create a new instance...
        final AciParameters parameters = new AciParameters(Arrays.asList(
    ...
    public void testHashCode() {
        final AciParameters parameters1 = AciParameters.convert(Arrays.asList(
                new AciParameter("action", "query"),
                new AciParameter("text", "test")
        ));

        final AciParameters parameters2 = AciParameters.convert(Arrays.asList(
    ...
    public void testGetMethod() {
        ...
        // Test a known good parameter...
        String result = parameters.get("combine");
        assertThat("Wrong result", result, is(equalTo("simple")));

        // Try a random name...
        result = parameters.get("aoljds");
    ...
    public void testGetMethodWithTurkishLocale() {
        ...
        // Test case conversion both ways round...
        String result = parameters.get("action");
        assertThat("Wrong result", result, is(equalTo("test")));

        result = parameters.get("COMBINE");
        assertThat("Wrong result", result, is(equalTo("simple")));
    ...
    public void testPutMethod() {
        ...
        String result = parameters.put("print", "all");
        assertThat("Wrong result", result, is(nullValue()));

        // Try putting an existing paramter...
        result = parameters.put("print", "fields");
    ...
    public void testPutAciParameterMethod() {
        ...
        // Test a known new parameter...
        AciParameter result = parameters.put(new AciParameter("print", "all"));
        assertThat("Wrong result", result, is(nullValue()));
    ...
    public void testPutAllMethod() {
        ...
        parameters.putAll((Collection<AciParameter>) null);
    ...
    public void testConvert() {
        final AciParameters aciParameters = AciParameters.convert(Arrays.asList(
                new AciParameter("action", "query"),
        ...
        assertThat("Not the same", AciParameters.convert(aciParameters), sameInstance(aciParameters));
        assertThat("Wrong size", aciParameters.size(), is(3));
    }
    ...
    public void testToArray() {
        ...
        AciParameter[] parameterArray = parameters.toArray();

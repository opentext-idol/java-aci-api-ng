...
/**
 * This is a utility class that encrypts and decrypts <code>String</code> objects, it main function is to hide the required
...
public class EncryptionCodecUtils {
     ...
     * conversions.
     * @param codec       The <code>EncryptionCodec</code> to use
    ...
    /**
     * Constructs a new <code>String</code> by decoding the specified array of bytes using the specified charset. The length
     * of the new <code>String</code> is a function of the charset, and hence may not be equal to the length of the byte
     * array.
     * <p>
     ...
     * @return A string representation of the <code>bytes</code> argument
     * @throws EncryptionCodecException If the named charset is not supported
     * @throws NullPointerException     If either <code>bytes</code> or <code>charsetName</code> is <code>null</code>
     */
    ...
    /**
     * Encodes the <code>string</code> into a sequence of bytes using the named charset, storing the result into a new byte
     * array.
     * <p>
     ...
     * @param string      The <code>String</code> to convert to a byte array.
     * @param charsetName The name of a supported {@link java.nio.charset.Charset </code>charset<code>}
     * @return The resultant byte array
     * @throws EncryptionCodecException If the named charset is not supported
     * @throws NullPointerException     if either <code>string</code> or <code>charsetName</code> is <code>null</code>
     */
